...
${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trickytact2.exe: ${OBJECTFILES}
	...
	${LINK.cc} -o ${CND_DISTDIR}/${CND_CONF}/${CND_PLATFORM}/trickytact2 ${OBJECTFILES} ${LDLIBSOPTIONS}

${OBJECTDIR}/src/GridMap.o: src/GridMap.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/GridMap.o src/GridMap.cpp

${OBJECTDIR}/src/SEngine.o: src/SEngine.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SEngine.o src/SEngine.cpp

${OBJECTDIR}/src/SSurface.o: src/SSurface.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SSurface.o src/SSurface.cpp

${OBJECTDIR}/src/SText.o: src/SText.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SText.o src/SText.cpp

${OBJECTDIR}/src/SVideo.o: src/SVideo.cpp 
	${MKDIR} -p ${OBJECTDIR}/src
	${RM} "$@.d"
	$(COMPILE.cc) -O2 -MMD -MP -MF "$@.d" -o ${OBJECTDIR}/src/SVideo.o src/SVideo.cpp
